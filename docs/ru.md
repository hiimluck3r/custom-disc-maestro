...
как делают винил в реальности (ну почти). Сочините мелодию, нарежьте её на
...
- **Конверты для пластинок** — оформление в духе настоящих обложек, вставленная пластинка
...
На станке и прессе сверху виден диск, пока он внутри.
...
- **Чистый конверт** крафтится из 8 бумаги, выложенной кольцом.
...
- **Положить пластинку:** возьмите конверт на курсор и **кликните ПКМ по пластинке** (или
  пластинкой по конверту) — она спрячется внутрь. **Достать:** ПКМ заполненным конвертом по пустой
  ячейке. ПКМ заполненным конвертом в руке — **выбросить пластинку на землю**. Из заполненного
  конверта **выглядывает край пластинки**. (Через верстак тоже можно: конверт + пластинка
  соединяются; заполненный конверт разбирается обратно.)
