...
Мод для **Minecraft 1.21.1** (NeoForge), который превращает создание пластинок в настоящий
производственный процесс — так, как делают винил в реальности. Сочините мелодию, нарежьте её на
...
1. Установите [NeoForge **21.1.228**](https://neoforged.net/) для Minecraft **1.21.1**.
2. Положите JAR мода в папку `mods/`.
3. Запустите игру.

Готовые JAR — на странице [Releases](https://github.com/hiimluck3r/custom-disc-maestro/releases).
